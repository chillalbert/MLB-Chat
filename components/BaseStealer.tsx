...
const BaseStealer: React.FC<BaseStealerProps> = ({ onGameOver, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[130] flex items-center justify-center bg-black/95 backdrop-blur-md p-4">
      <div className="w-full max-w-md bg-slate-900 rounded-[2.5rem] shadow-2xl overflow-hidden relative p-8 border border-slate-800">
        <h2 className="text-2xl font-black text-white uppercase italic text-center mb-2">90ft Sprint</h2>
        <p className="text-center text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] mb-8">Alternate LEFT and RIGHT to steal!</p>

        ...
        >
          ...
          {gameState === 'ready' && (
            <div className="text-white animate-pulse">
              <p className="text-7xl font-black uppercase tracking-tighter">HIT IT!</p>
            </div>
          )}
          {gameState === 'result' && (
            <div className="text-white">
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">REACTION TIME</p>
